...
public class listEtudiantActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAddBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(listEtudiantActivity.this, GestionEtudiantActivity.class));
                finish();
            }
        });
    ...
    private void showData() {
        ...
        db.collection("Users").whereEqualTo("role", "Elève")
                .get()
                .addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        ...
                        //adapter
                        adapter = new CustomAdapter(listEtudiantActivity.this, modelList);
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        ...
                        Toast.makeText(listEtudiantActivity.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                })
        ;
    }
